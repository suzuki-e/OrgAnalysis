...
class ReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reaction" do
    assert_difference('Reaction.count') do
      post reactions_url, params: { reaction: { count: @reaction.count, emoji_id: @reaction.emoji_id, message_id: @reaction.message_id } }
    end
  ...
  test "should update reaction" do
    patch reaction_url(@reaction), params: { reaction: { count: @reaction.count, emoji_id: @reaction.emoji_id, message_id: @reaction.message_id } }
